...
import random
import ctypes
from ctypes import wintypes, Structure, Union, c_ulong, c_uint64, sizeof, POINTER, c_int, c_uint, c_bool
...
class WinSystem:
    ...
    def is_user_an_admin() -> bool:
        try:
            # [修复] 使用 WinSystem._shell32 而不是直接用 _shell32
